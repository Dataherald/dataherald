...
const TILES: TemplateTiles[] = [
  {
    ...
    description: "Quickly create an offering memorandum with investment data and property photos",
    disabled: true,
  },
  {
    icon: "rss_feed",
    title: "Blog Post",
    description: "Start a blog post using your own data or supplement with Dataherald sources",
    disabled: true,
  },
  {
    icon: "smartphone",
  ...
  },
  {
    icon: "description",
    title: "Newsletter",
    description: "Link a dataset and let Dataherald summarize key metrics and visualize trends",
    disabled: true,
  },
  {
    icon: "email",
    title: "Marketing Email",
    description: "Marketing emails with data visualizations have a 22% clickrate than those without",
    disabled: true,
  }
]
