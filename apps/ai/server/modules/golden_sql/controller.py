...
async def api_add_user_upload_golden_sql(
...
async def api_delete_golden_sql(id: str, api_key: str = Security(get_api_key)):
    return await golden_sql_service.delete_golden_sql(
